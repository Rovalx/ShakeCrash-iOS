...
//            let request = NSMutableURLRequest(URL: NSURL(string: "\(redmineAddress)/projects/\(projectId)/issues.json")! as URL)
...
//				title += "] Report"
//			}
//            let versioNumber = Bundle.mainBundle().objectForInfoDictionaryKey("CFBundleShortVersionString")!
//            let appBuildNumber = Bundle.mainBundle().objectForInfoDictionaryKey("CFBundleVersion")!
